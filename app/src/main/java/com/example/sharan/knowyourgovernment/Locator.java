...
//                Toast.makeText(owner, "Update from " + location.getProvider(), Toast.LENGTH_SHORT).show();
        ...
        locationManager.requestLocationUpdates(
                LocationManager.GPS_PROVIDER, 1000000, 1000, locationListener);
    ...
    // This method chooses the best location provider Network ==> GPS ==> Passive
    public void determineLocation() {
        ...
        if (locationManager != null && owner.doNetCheck()) {
